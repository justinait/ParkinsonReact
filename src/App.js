    ...
    <div className="app">
      <header className="header">
        ...
        <div className="rightHeader">
          ...
          <p className="icons">bell</p>
          <p className="icons">msg</p>
          <p className="icons">user</p>
        </div>
      ...
      <div className='gallery'>
          {
            data.map((e) => (
              <div className="painting" key={e.id}>
                <img src={e.mainImage} alt="painting" />
                <h5>{e.title}</h5>
              </div>
            ))
          }
